...
<?php 
	...
	Cita_Medica.NumeroDocSolicitante = $num_doc_session and Cita_Medica.Estado = 'Se realizo' order by Cita_Medica.id_cita;")->fetchall();
?>
            <!-- Page header -->
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    ...
                    <li>
                        <a class="active" href="cita-realized.php"><i class="fas fa-check fa-fw"></i> &nbsp; CITAS REALIZADAS</a>
                    </li>
					<li>
